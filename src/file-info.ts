...
export class FileInfo {
  ...
  get thumbnailPath(): string | null {
    const failed = this._gioInfo.get_attribute_boolean(
      "thumbnail::failed",
    );
    ...
    const isValid = this._gioInfo.get_attribute_boolean(
      "thumbnail::valid",
    );
  ...
  /**
   * The time the file was last accessed in milliseconds since the
   * UNIX epoch.
   */

  get accessTime() {
    const sec = this._gioInfo.get_attribute_uint64("time::access");
    const usec = this._gioInfo.get_attribute_uint32(
      "time::access-usec",
    );
  ...
  /**
   * The time the file was last modified in milliseconds since the
   * UNIX epoch.
   */
  get modifiedTime() {
  ...
  /**
   * The time the file was last changed in milliseconds since the UNIX
   * epoch.
   */
  get changedTime() {
...
/**
 * A list of attributes used in every File operation within fs-gjs.
 */
